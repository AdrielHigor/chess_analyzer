...
def render_sidebar_board_options():
    """Render the board customization options in the sidebar."""
    ...
    return size, board_theme


def render_ai_assistant():
    """Render the AI assistant section in the sidebar."""
    with st.sidebar:
...
def render_move_interface():
    """Render the move input interface."""
...
def render_game_status():
    """Render the game status display."""
...
def render_game_info():
    """Render the game information panel (selected piece, captures, move history)."""
...
def main():
    ...
    size, board_theme = render_sidebar_board_options()
    render_ai_assistant()

    col1, col2, col3 = st.columns([1, 5, 1])

    with col1:
        render_move_interface()
